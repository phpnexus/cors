...
class CorsServiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function test_section_6_1_1()
    {
        ...
        $result = $cors->process((new ServerRequest)
            ->withMethod('GET')
        );
    ...
    public function test_section_6_1_2()
    {
        ...
        $result = $cors->process((new ServerRequest)
            ->withMethod('GET')
            ->withHeader('Origin', 'http://bad.example.com')
        );
    ...
    public function test_section_6_2_3()
    {
        ...
        $result = $cors->process((new ServerRequest)
            ->withMethod('OPTIONS')
            ->withHeader('Access-Control-Request-Method', 'GET ALL')
            ->withHeader('Origin', 'http://example.com')
        );
    ...
    public function test_section_6_2_10_simple()
    {
        ...
        $result = $cors->process((new ServerRequest)
            ->withMethod('OPTIONS')
            ->withHeader('Access-Control-Request-Method', 'GET')
            ->withHeader('Access-Control-Request-Headers', ['Accept', 'Accept-Language', 'Content-Language'])
            ->withHeader('Origin', 'http://example.com')
        );
